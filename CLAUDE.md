...
| 브랜치 | 내용 | PR |
|--------|------|----|
| feat/pagination | 인터뷰/문서 목록 Pageable | #2 |
| feat/interview-cancel | PATCH /interviews/{id}/cancel | #5 |
| feat/interview-stats | GET /interviews/stats | #4 |
| refactor/hibernate-ddl | ddl-auto: create → update | #8 |
| refactor/document-upload | 다중 업로드, documentType PATCH, 파일 크기 제한 수정 | #15 |
